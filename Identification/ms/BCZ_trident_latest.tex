...
\noindent{\LARGE\bf Identifying Taylor rules in macro-finance models\footnote{%
...
%\newline\centerline
{\url{http://pages.stern.nyu.edu/~dbackus/Identification/ms/BCZ_trident_latest.pdf}.}
}}
