...
\noindent{\LARGE\bf Identifying Taylor rules\footnote{%
...
We thank them both.
%We also owe obvious debts to Lars Hansen, Thomas Sargent, and Christopher Sims.
% ??
...
We illustrate these ideas with variations on a single example.
...
\begin{verbatim}
Outline:
(i) Bla bla about id in monetary models
(ii) History of id in RE models
(iii) Generic example
\end{verbatim}
...
%\paper{Bansal, Gallant, and Tauchen, REStud, 2007}

\paper{Christiano, Eichenbaum, and Evans ??}
